...
def test_loads_from_env_with_no_defaults(tmp_path: pathlib.Path):
    ...
    env = dict(CHECK_EVERY='hour', CHECK_EVERY_MUL='193' HEALTHCHECK_URL='http://healthcheck.example.com', PORT=792, RSS_CACHE='/tmp/nosuchfile.rss', START_AT_HOUR='13', START_AT_MINUTE='57', FILE_EXTENSION='.test-extension', LINUX_RSS_SERVER_CONFIG=str(config_file.absolute()),)
